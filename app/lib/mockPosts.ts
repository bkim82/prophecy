...
export const GLOBAL_POSTS: Post[] = [
  {
    ...
    handle: "@nova_trades",
    avatarInitial: "N",
    content: "Called BTC up 3 rounds in a row. Quick Play is printing today.",
    timestamp: "2m ago",
    likes: 41,
    replies: 6,
    kind: "result",
  ...
  },
  {
    ...
    handle: "@8bitkay",
    avatarInitial: "K",
    content: "New to Duel, just won my first head-to-head. This is way more fun than I expected.",
    timestamp: "11m ago",
    likes: 63,
    replies: 12,
    kind: "text",
  ...
  },
  {
    ...
    handle: "@priya_p",
    avatarInitial: "P",
    content: "Anyone else notice the 24hr Battle mode is still \"soon\"? Been waiting on this one.",
    timestamp: "38m ago",
    likes: 27,
    replies: 8,
    kind: "text",
