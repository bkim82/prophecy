...
// neither `href` nor `matched`, which the panel below renders as "soon" and
// leaves inert. `matched` means the mode has no fixed URL — pressing Play asks
// the server for a match and routes to whatever room comes back.
