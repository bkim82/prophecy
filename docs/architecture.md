...
- The duel lobby may read `usePriceFeed()` for live market display (`app/duel/page.tsx:133`), but settlement logic stays out of it — Quick Play settles on the server (`lib/match.ts:64`), Pulse in its own page.
