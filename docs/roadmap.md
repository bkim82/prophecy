...
- The 250ms clock (`app/usePriceFeed.ts:48-51`) re-renders `page.tsx` 4x/s even when nothing else changes. Cheap at this size; would want memoising the chart if the page grows.
